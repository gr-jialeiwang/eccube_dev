...
*}-->
    ...
    <!--{foreach from=$arrProducts item=arrProduct name=arrProducts}-->
        ...
        <div class="list_area clearfix">
            <!--★画像★-->
            <p class="listphoto"><img src="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$arrProduct.main_list_image|sfNoImageMainList|h}-->" style="max-width:100%;" alt="<!--{$arrProduct.name|h}-->" /></p>
...
*}-->
                ...
                <!--★商品価格★-->
                <p>
                    <span class="pricebox sale_price"><!--{*$smarty.const.SALE_PRICE_TITLE|h*}--></span>
                    <span class="price">
