...
<section id="product_detail">
    ...
    <div id="detailphotoblock" class="mainImageInit">
        <ul>
            ...
            <!--{* 画像の縦横倍率を算出 *}-->
            <!--{assign var=detail_image_size value=220}-->
            <!--{assign var=main_image_factor value=`$arrFile[$key].height/$detail_image_size`}-->
            ...
            <!--{assign var=sub_image_factor value=`$arrFile[$key].height/$detail_image_size`}-->
            ...
            <!--{section name=cnt loop=$smarty.const.PRODUCTSUB_MAX}-->
                ...
                <!--{if $arrProduct[$key] != ""}-->
                    ...
                    <div class="subarea clearfix">
                        ...
                        <!--★サブ画像★-->
                        <!--{assign var=sub_image_size value=240}-->
                        <!--{assign var=key value="sub_image`$smarty.section.cnt.index+1`"}-->
                        <!--{assign var=lkey value="sub_large_image`$smarty.section.cnt.index+1`"}-->
                        <!--{assign var=ckey value="sub_comment`$smarty.section.cnt.index+1`"}-->
