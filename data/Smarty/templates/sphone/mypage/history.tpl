        ...
        <div class="formBox">
            ...
            <div class="cartinarea clearfix">
                ...
                <!--{foreach from=$tpl_arrOrderDetail item=orderDetail}-->
                    <div>
                        <img src="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$orderDetail.main_list_image|sfNoImageMainList|h}-->" style="max-width: 80px;max-height: 80px;width:auto;" alt="<!--{$orderDetail.product_name|h}-->" class="photoL" />
