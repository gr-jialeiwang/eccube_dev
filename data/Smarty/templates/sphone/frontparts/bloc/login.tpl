...
<nav class="top_menu clearfix">
    <!--{if $tpl_login}-->
        <ul>
            <li><a rel="external" href="javascript:void(document.login_form_bloc.submit())"><img src="<!--{$TPL_URLPATH}-->img/icon/ico_login.png" width="26" height="24" alt="ログアウト" />ログアウト</a></li>
            <li><a rel="external" href="<!--{$smarty.const.HTTPS_URL}-->mypage/login.php" data-transition="slideup"><img src="<!--{$TPL_URLPATH}-->img/icon/ico_mypage.png" width="26" height="24" alt="MYページ" />MYページ</a></li>
            <li><a rel="external" href="<!--{$smarty.const.CART_URL|h}-->"><img src="<!--{$TPL_URLPATH}-->img/icon/ico_cart.png" width="26" height="24" alt="カートを見る" />カートを見る</a></li>
        </ul>
    <!--{else}-->
        <ul>
