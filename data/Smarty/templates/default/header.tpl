...
<!--{strip}-->
    <div id="header_wrap">
        <div id="header" class="clearfix">
            <div id="logo_area">
                <p id="site_description">ゲイのためのポータルサイト「Badi.jp」</p>
                <a href="<!--{$smarty.const.TOP_URL}-->"><img src="<!--{$TPL_URLPATH}-->img/common/logo_pc.png" alt="<!--{$arrSiteInfo.shop_name|h}-->/<!--{$tpl_title|h}-->" /></a>
            </div>
