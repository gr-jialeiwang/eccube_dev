            ...
            <div class="list_area clearfix">
                ...
                <div class="listrightbloc">
                    ...
                    <div class="detail_btn">
                        ...
                        <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->">
                            <img class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_detail.png" alt="商品詳細を見る" name="<!--{$name}-->" width="160" height="32" id="<!--{$name}-->" />
                        </a>
                    </div>
                            ...
                            <div class="cartin clearfix">
                                ...
                                <div class="cartin_btn">
                                    ...
                                    <div id="cartbtn_default_<!--{$id}-->">
                                        <input type="image" id="cart<!--{$id}-->" src="<!--{$TPL_URLPATH}-->img/button/btn_cartin.png" width="160" height="32" alt="カゴに入れる" onclick="fnInCart(this.form); return false;" class="hover_change_image" />
                                    </div>
