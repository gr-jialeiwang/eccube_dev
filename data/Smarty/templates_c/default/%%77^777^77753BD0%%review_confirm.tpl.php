<?php /* Smarty version 2.6.27, created on 2015-11-18 18:39:47
...
" />
        ...
        <div class="btn_area">
            <ul>
                <li><input type="image" onclick="mode.value='return';" class="hover_change_image" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
