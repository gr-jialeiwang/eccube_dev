<?php /* Smarty version 2.6.27, created on 2015-08-31 15:03:44
         compiled from shopping/nonmember_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'shopping/nonmember_input.tpl', 26, false),array('modifier', 'h', 'shopping/nonmember_input.tpl', 44, false),array('modifier', 'sfGetErrorColor', 'shopping/nonmember_input.tpl', 63, false),array('modifier', 'default', 'shopping/nonmember_input.tpl', 106, false),array('modifier', 'sfGetChecked', 'shopping/nonmember_input.tpl', 267, false),array('function', 'html_options', 'shopping/nonmember_input.tpl', 106, false),)), $this); ?>
...
"
            ...
            <dt>会社名</dt>
            <dd>
                <?php $this->assign('key', 'order_company_name'); ?>
...
" class="boxLong text data-role-none" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" />
            </dd>
...
">
            ...
            <dt>ZIP CODE</dt>
            <dd>
                <?php $this->assign('key1', 'order_zipcode'); ?>
                <div class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key1']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</div>
                <input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key1'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key1']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
" class="boxLong data-role-none">
            ...
            <dt>生年月日</dt>
            <dd>
                <?php $this->assign('key1', 'order_year'); ?>
                <?php $this->assign('key2', 'order_month'); ?>
                <?php $this->assign('key3', 'order_day'); ?>
...
" value="1" onchange="fnDelivToggle($('#add_deliv_area')); eccube.toggleDeliveryForm();" <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetChecked', true, $_tmp, 1) : SC_Utils_Ex::sfGetChecked($_tmp, 1)); ?>
 id="deliv_label" />
...
"
                ...
                <dt>フリガナ<?php if (! ((is_array($_tmp=@FORM_COUNTRY_ENABLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>&nbsp;<span class="attention">※</span><?php endif; ?></dt>
                <dd>
...
"
                ...
                <dt>会社名</dt>
                <dd>
                    <?php $this->assign('key', 'shipping_company_name'); ?>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                    <input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
